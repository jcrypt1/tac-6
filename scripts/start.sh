...
echo -e "${BLUE}Frontend: http://127.0.0.1:$CLIENT_PORT${NC}"
echo -e "${BLUE}Backend:  http://127.0.0.1:$SERVER_PORT${NC}"
echo -e "${BLUE}API Docs: http://127.0.0.1:$SERVER_PORT/docs${NC}"
echo ""
