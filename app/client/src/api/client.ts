...
const API_BASE_URL = import.meta.env.DEV 
  ...
  : 'http://127.0.0.1:8001/api';  // Direct backend in production
...
export const api = {
  ...
  // Export table as CSV (triggers browser download)
  ...
  // Export query results as CSV (triggers browser download)
